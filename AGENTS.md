...
This project is indexed by GitNexus as **vibe-kanban** (13004 symbols, 30947 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/vibe-kanban/process/{processName}` — trace the full execution flow step by step
