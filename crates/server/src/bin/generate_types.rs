...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::github_import::ImportGitHubIssuesRequest::decl(),
        server::routes::github_import::ImportGitHubIssueFailure::decl(),
        server::routes::github_import::ImportGitHubIssuesResponse::decl(),
        ...
        executors::executors::bob::Bob::decl(),
...
fn generate_schemas() -> Result<HashMap<&'static str, String>, serde_json::Error> {
    ...
    let schemas: HashMap<&str, String> = HashMap::from([
        ...
        (
            "bob",
            generate_json_schema::<executors::executors::bob::Bob>()?,
        ),
        (
            "cursor_agent",
