...
export enum BaseCodingAgent { CLAUDE_CODE = "CLAUDE_CODE", AMP = "AMP", GEMINI = "GEMINI", CODEX = "CODEX", BOB = "BOB", OPENCODE = "OPENCODE", CURSOR_AGENT = "CURSOR_AGENT", QWEN_CODE = "QWEN_CODE", COPILOT = "COPILOT", DROID = "DROID" }

export type CodingAgent = { "CLAUDE_CODE": ClaudeCode } | { "AMP": Amp } | { "GEMINI": Gemini } | { "CODEX": Codex } | { "BOB": Bob } | { "OPENCODE": Opencode } | { "CURSOR_AGENT": CursorAgent } | { "QWEN_CODE": QwenCode } | { "COPILOT": Copilot } | { "DROID": Droid };
...
export type ExecutorProfile = { recently_used_models?: ExecutorRecentModels | null, } & ({ [key in string]?: { "CLAUDE_CODE": ClaudeCode } | { "AMP": Amp } | { "GEMINI": Gemini } | { "CODEX": Codex } | { "BOB": Bob } | { "OPENCODE": Opencode } | { "CURSOR_AGENT": CursorAgent } | { "QWEN_CODE": QwenCode } | { "COPILOT": Copilot } | { "DROID": Droid } });
...
export type Bob = { append_prompt: AppendPrompt, model?: string | null, sandbox?: boolean | null, sandbox_type?: string | null, seatbelt_profile?: string | null, sandbox_flags?: string | null, sandbox_set_uid_gid?: boolean | null, trust?: boolean | null, instance_id?: string | null, team_id?: string | null, max_coins?: number | null, pre_check_auto_approved?: boolean | null, allowed_tools?: Array<string> | null, allowed_mcp_server_names?: Array<string> | null, include_directories?: Array<string> | null, approval_mode?: string | null, chat_mode?: string | null, hide_intermediary_output?: boolean | null, base_command_override?: string | null, additional_params?: Array<string> | null, env?: { [key in string]?: string } | null, };
